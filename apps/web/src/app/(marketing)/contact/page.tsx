              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      <label className="text-sm text-muted-foreground block mb-2">Name <span style={{ color: '#dc2626' }}>*</span></label>
                      <Input
                        type="text"
                        value={formData.name}
                    ...
                    <div>
                      <label className="text-sm text-muted-foreground block mb-2">Email <span style={{ color: '#dc2626' }}>*</span></label>
                      <Input
                        type="email"
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground block mb-2">Message <span style={{ color: '#dc2626' }}>*</span></label>
                    <Textarea
                      rows={5}
